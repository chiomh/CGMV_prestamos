...
if ${maketable}==1 putexcel set $StataOut/CompareSystems.xlsx, replace

global Q=0
if ${maketable}==1 putexcel set $StataOut/CompareSystems.xlsx, modify sheet(${Q},replace)
if ${maketable}==1 putexcel A1="CASE" B1="SUBSIDY"
...
pause
	...
	if ${maketable}==1 {
		local ic=`i'+2
		putexcel A1="CASE" B1="SUBSIDY"
		putexcel A`ic'=`i' B`ic'=100*$meansub
	}
